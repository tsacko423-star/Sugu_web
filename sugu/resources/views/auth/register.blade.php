<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Numéro de téléphone -->
        <div class="mt-4">
            <x-input-label for="numero" :value="__('Numéro de téléphone')" />
            <x-text-input id="numero" class="block mt-1 w-full text-black" type="text" name="numero" :value="old('numero')" required autocomplete="tel" />
